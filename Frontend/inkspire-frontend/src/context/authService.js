...
// const authService = {
//   //register new user
//   register: async (name, email, username, password, confirmPassword, role) => {
//     const registerData = {
//       name,
//       email,
//       userName: username,
...
//     // Add role to headers since it's not part of the RegisterDTO
//     const config = {
//       headers: {
//         Role: role,
//       },
...
//     const response = await api.post("/api/auth/register", registerData, config);
